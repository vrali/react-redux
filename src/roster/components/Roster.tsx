...
import { RosterStyle, styles } from "./Roster.style";

interface Props {}

class Roster extends React.Component<Props & WithStyles<RosterStyle>> {
  state = {};
          ...
          {tileData.map(tile => (
            <GridListTile key={tile.img} cols={tile.cols || 1}>
              <Card className={classes.tile}>
                ...
                <CardActions>
                  <Button color="secondary" centerRipple variant="raised">
                    {" "}
                    Action1{" "}
                  </Button>
                </CardActions>
